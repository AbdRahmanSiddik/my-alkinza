  ...
  <div class="alert bg-orange-transparent alert-dismissible fade show mb-4">
    <div>
      <span><i class="ti ti-info-circle fs-14 text-orange me-2"></i>Your Product </span> <span
        ...
        href="javascript:void(0);" class="link-orange text-decoration-underline fw-semibold" data-bs-toggle="modal"
      ...
      <div class="card flex-fill">
        ...
        <div class="card-body sell-product">
          <div class="d-flex align-items-center justify-content-between border-bottom">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-01.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-01.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between border-bottom">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-16.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-16.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between border-bottom">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-03.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-03.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between border-bottom">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-04.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-04.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-05.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-05.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
      ...
      <div class="card flex-fill">
        ...
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-06.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-06.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-07.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-07.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-08.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-08.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-09.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-09.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between mb-0">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-10.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-10.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
      ...
      <div class="card flex-fill">
        ...
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-11.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-11.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-12.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-12.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-13.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-13.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-14.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-14.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between mb-0">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img alt="img" data-cfsrc="{{ asset('assets/img/products/product-15.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/products/product-15.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
      ...
      <div class="card flex-fill">
        ...
        <div class="card-body p-0">
          <ul class="nav nav-tabs nav-justified transaction-tab">
            ...
            <li class="nav-item"><a class="nav-link" href="#purchase-transaction" data-bs-toggle="tab">Purchase</a>
            </li>
                        ...
                        <div class="d-flex align-items-center file-name-icon">
                          <a href="javascript:void(0);" class="avatar avatar-md">
                            <img class="img-fluid" alt="img"
                              data-cfsrc="{{ asset('assets/img/customer/customer16.jpg') }}"
                              style="display:none;visibility:hidden;"><noscript><img
                                src="{{ asset('assets/img/customer/customer16.jpg') }}" class="img-fluid"
                                alt="img"></noscript>
                          </a>
                          <div class="ms-2">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center file-name-icon">
                          <a href="javascript:void(0);" class="avatar avatar-md">
                            <img class="img-fluid" alt="img"
                              data-cfsrc="{{ asset('assets/img/customer/customer17.jpg') }}"
                              style="display:none;visibility:hidden;"><noscript><img
                                src="{{ asset('assets/img/customer/customer17.jpg') }}" class="img-fluid"
                                alt="img"></noscript>
                          </a>
                          <div class="ms-2">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center file-name-icon">
                          <a href="javascript:void(0);" class="avatar avatar-md">
                            <img class="img-fluid" alt="img"
                              data-cfsrc="{{ asset('assets/img/customer/customer18.jpg') }}"
                              style="display:none;visibility:hidden;"><noscript><img
                                src="{{ asset('assets/img/customer/customer18.jpg') }}" class="img-fluid"
                                alt="img"></noscript>
                          </a>
                          <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center file-name-icon">
                          <a href="javascript:void(0);" class="avatar avatar-md">
                            <img class="img-fluid" alt="img"
                              ...
                              style="display:none;visibility:hidden;"><noscript><img
                                src="{{ asset('assets/img/customer/customer15.jpg') }}" class="img-fluid"
                                alt="img"></noscript>
                          </a>
                          <div class="ms-2">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center file-name-icon">
                          <a href="javascript:void(0);" class="avatar avatar-md">
                            <img class="img-fluid" alt="img"
                              data-cfsrc="{{ asset('assets/img/customer/customer13.jpg') }}"
                              style="display:none;visibility:hidden;"><noscript><img
                                src="{{ asset('assets/img/customer/customer13.jpg') }}" class="img-fluid"
                                alt="img"></noscript>
                          </a>
                          <div class="ms-2">
      ...
      <div class="card flex-fill">
        ...
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between border-bottom mb-3 pb-3 flex-wrap gap-2">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
                <img alt="img" data-cfsrc="{{ asset('assets/img/customer/customer11.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/customer/customer11.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between border-bottom mb-3 pb-3 flex-wrap gap-2">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
                <img alt="img" data-cfsrc="{{ asset('assets/img/customer/customer12.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/customer/customer12.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between border-bottom mb-3 pb-3 flex-wrap gap-2">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
                <img alt="img" data-cfsrc="{{ asset('assets/img/customer/customer13.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/customer/customer13.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between border-bottom mb-3 pb-3 flex-wrap gap-2">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
                <img alt="img" data-cfsrc="{{ asset('assets/img/customer/customer14.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/customer/customer14.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
                <img alt="img" data-cfsrc="{{ asset('assets/img/customer/customer15.jpg') }}"
                  style="display:none;visibility:hidden;"><noscript><img
                    src="{{ asset('assets/img/customer/customer15.jpg') }}" alt="img"></noscript>
              </a>
              <div class="ms-2">
    ...
    <div class="col-xxl-4 col-md-6 d-flex">
      <div class="card flex-fill">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
          ...
          <div class="dropdown">
            <a href="javascript:void(0);" class="dropdown-toggle btn btn-sm btn-white d-flex align-items-center"
          ...
          <div class="border br-8">
            <div class="d-flex align-items-center justify-content-between border-bottom p-2">
              <p class="d-inline-flex align-items-center mb-0"><i
                  class="ti ti-square-rounded-filled text-indigo fs-8 me-2"></i>Total Number Of Categories</p>
              <h5>698</h5>
            </div>
            <div class="d-flex align-items-center justify-content-between p-2">
              <p class="d-inline-flex align-items-center mb-0"><i
                  class="ti ti-square-rounded-filled text-orange fs-8 me-2"></i>Total Number Of Products</p>
              <h5>7899</h5>
            </div>
          </div>
        </div>
